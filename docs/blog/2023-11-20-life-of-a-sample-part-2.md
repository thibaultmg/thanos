...
* As a rule of thumb, you can consider that each downsampled data level increases the storage need by onefold. It is most often less than that, but depending on your data, plan for the worst case.
